...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "ext4deft.Application": [],
  "ext4deft.context.GoogleMapContext": [],
  "ext4deft.controller.ActionFormContainerController": [],
  "ext4deft.controller.InfoDetailPanelController": [],
  "ext4deft.controller.LocationGridController": [],
  "ext4deft.controller.MapContainerController": [],
  "ext4deft.model.Location": [],
  "ext4deft.store.LocationStore": [],
  "ext4deft.view.ActionFormContainer": [],
  "ext4deft.view.InfoDetailPanel": [],
  "ext4deft.view.LocationGridPanel": [],
  "ext4deft.view.MapContainer": [],
  "ext4deft.view.Viewport": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "ext4deft.store.LocationStore": [],
  "ext4deft.view.ActionFormContainer": [
    "widget.actionFormContainer"
  ],
  "ext4deft.view.InfoDetailPanel": [
    "widget.infoDetailPanel"
  ],
  "ext4deft.view.LocationGridPanel": [
    "widget.locationGrid"
  ],
